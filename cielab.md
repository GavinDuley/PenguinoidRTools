...
- `standalone_functions.R` - Standalone functions designed for future R package integration
- `OIVConversionFunctions.R` - Original implementation with project-specific dependencies
- `CIELAB_LoadFormatSpectroscData.R` - Data loading scripts for specific spectrophotometer formats

## Standalone Functions Reference

The `standalone_functions.R` file contains documented, optimised versions of the core functions suitable for package development.
...
# spectroscopy_data has columns: WineName, EtOH, Replicate, X780, X779, ... X380
...
### For visualisation (`cielab_swatch`)
- ggplot2
- colorspace
